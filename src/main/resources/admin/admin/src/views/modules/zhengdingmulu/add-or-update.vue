<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="征订状态" prop="zhengdingzhuangtai">
          <el-select v-model="ruleForm.zhengdingzhuangtai" placeholder="请选择征订状态">
            <el-option
                v-for="(item,index) in zhengdingzhuangtaiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="征订状态" prop="zhengdingzhuangtai">
	      <el-input v-model="ruleForm.zhengdingzhuangtai"
                placeholder="征订状态" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.neirong = true;
          ...
          if(o=='zhengdingzhuangtai'){
            this.ruleForm.zhengdingzhuangtai = obj[o];
	    this.ro.zhengdingzhuangtai = true;
            continue;
          }
          if(o=='dengjishijian'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `zhengdingmulu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zhengdingmuluCrossAddOrUpdateFlag = false;
                  this.parent.search();
