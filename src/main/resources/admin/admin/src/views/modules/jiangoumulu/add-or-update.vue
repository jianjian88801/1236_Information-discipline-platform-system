    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="推荐理由" prop="tuijianliyou">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.tuijianliyou" label="推荐理由" prop="tuijianliyou">
                    <span>{{ruleForm.tuijianliyou}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `jiangoumulu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jiangoumuluCrossAddOrUpdateFlag = false;
                  this.parent.search();
