    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="专业编辑" prop="zhuanyebianji">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="专业编辑"
                  v-model="ruleForm.zhuanyebianji" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhuanyebianji" label="专业编辑" prop="zhuanyebianji">
                    <span>{{ruleForm.zhuanyebianji}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhuanyemingcheng = true;
          ...
          if(o=='zhuanyebianji'){
            this.ruleForm.zhuanyebianji = obj[o];
	    this.ro.zhuanyebianji = true;
            continue;
          }
          if(o=='zhuanyejianjie'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `xuekegaikuang/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xuekegaikuangCrossAddOrUpdateFlag = false;
                  this.parent.search();
