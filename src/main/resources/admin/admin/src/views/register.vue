  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 1);borderRadius:20px">
        <h1 class="h1" style="color:#000;fontSize:26px;">保密信息学科平台系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="学院" class="input" v-if="tableName=='yonghu'">
			...
			<el-form-item label="账号" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.zhanghao" autocomplete="off" placeholder="账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
			   <div class="label">密码</div>
			...
			<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
			   <div class="label">军衔</div>
			   <div class="input-container">
			     <input v-model="ruleForm.junxian" class="input" type="text" placeholder="军衔">
			   </div>
			 </div> -->
			<el-form-item label="军衔" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.junxian" autocomplete="off" placeholder="军衔"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
			...
			<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
			   <div class="label">办公地点</div>
			   <div class="input-container">
			     <input v-model="ruleForm.bangongdidian" class="input" type="text" placeholder="办公地点">
			   </div>
			 </div> -->
			<el-form-item label="办公地点" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.bangongdidian" autocomplete="off" placeholder="办公地点"  />
			</el-form-item>
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      if((!this.ruleForm.zhanghao) && `jiaoshi` == this.tableName){
        this.$message.error(`账号不能为空`);
        return
      }
