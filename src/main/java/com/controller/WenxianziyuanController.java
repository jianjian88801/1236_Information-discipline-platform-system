...
public class WenxianziyuanController {
    ...
    public R info(@PathVariable("id") Long id){
		...
		wenxianziyuan.setClicknum(wenxianziyuan.getClicknum()+1);
		wenxianziyuan.setClicktime(new Date());
		wenxianziyuanService.updateById(wenxianziyuan);
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<WenxianziyuanEntity> wrapper = new EntityWrapper<WenxianziyuanEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = wenxianziyuanService.selectCount(wrapper);
    ...
    public R autoSort(@RequestParam Map<String, Object> params,WenxianziyuanEntity wenxianziyuan, HttpServletRequest request,String pre){
        EntityWrapper<WenxianziyuanEntity> ew = new EntityWrapper<WenxianziyuanEntity>();
